<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="ManageItem.aspx.cs" Inherits="RentMyWrox.Admin.ManageItem" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div style="margin-top: 100px;">
        ...
        <div class="dataentry">
            <asp:Label runat="server" Text="Aquired Date" AssociatedControlID="tbAcquiredDate" />
